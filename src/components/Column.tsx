...
export default function Column({
  ...
  return (
    ...
    >
          ...
          {showOptions && (
            <div className="absolute right-0 top-10 bg-white rounded-lg shadow-lg border border-gray-200 z-20 w-48">
              ...
              <button
                ...
                className="w-full text-left px-4 py-2 hover:bg-red-50 text-red-600 border-t border-gray-200"
              >
                Delete Column
              </button>
            </div>
      ...
      {/* Cards Container */}
      <div
        className={`flex-1 w-full bg-gray-50/50 py-4 rounded-b-2xl flex flex-col gap-3  max-h-[calc(100vh-200px)] overflow-y-auto ${isOver ? "bg-blue-50/50" : ""}`}
      >
