// routes/_authenticated/board/$boardId.tsx
...
// ✅ Component that uses Kanban (inside provider)
...
// ✅ Main Board Component with Providers
  ...
  return (
    <CommentProvider>
      <KanbanProvider boardId={boardId}>
        <KanbanBoardContent boardId={boardId} onBack={handleBack} />
      </KanbanProvider>
    </CommentProvider>
  );
}
